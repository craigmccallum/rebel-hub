...
export const darkModeClass = createTheme(colorModeVars, {
  colors: generateThemeColors({
    background: baseThemeVars.colors.grey1,
    textOnBackground: baseThemeVars.colors.grey10,
    primary: baseThemeVars.colors.orange6,
